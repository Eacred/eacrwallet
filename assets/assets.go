...
// Path returns the absolute filepath of a file in the eacrwallet main module,
// relative to the assets package.
//
// For example, to access the filepath of a sample-eacrwallet.conf file from the
// root of the main module, call Path("../sample-eacrwallet.conf").
//
