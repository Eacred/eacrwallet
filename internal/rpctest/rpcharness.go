...
// Harness fully encapsulates an active eacrd process, along with an embedded
// eacrwallet to provide a unified platform for creating RPC-driven integration
// tests involving eacrd. The active eacrd node will typically be run in simnet
...
// spends. The active eacrd process is fully managed by Harness, which handles
...
func (h *Harness) SetUp(createTestChain bool, numMatureOutputs uint32) error {
	...
	// Start eacrwallet. This spawns a new process which will be managed
	...
	// Get a new address from the wallet to be set with eacrd's --miningaddr
...
// eacrd process belonging to this Harness instance. If the initial connection
