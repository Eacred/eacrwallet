...
// walletTestConfig contains all the args, and data required to launch a eacrwallet process
...
// command returns the exec.Cmd which will be used to start the eacrwallet
// process.
...
// to connect to the eacrwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for eacrwallet.
...
// Start creates a new eacrwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running eacrwalletTest process process, and waits until it exits
