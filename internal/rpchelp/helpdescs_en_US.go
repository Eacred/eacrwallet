...
var helpDescsEnUS = map[string]string{
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in eacred",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in eacred",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in eacred",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and eacred amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in eacred",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in eacred",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in eacred",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in eacred",
	...
	"listunspentresult-amount":        "The amount of the output valued in eacred",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in eacred",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in eacred to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in eacred",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in eacred",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in eacred",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in eacred",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in eacred.",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in eacred",
