...
[![GoDoc](https://godoc.org/github.com/Eacred/ecrwallet/wallet/v2/walletdb?status.png)](https://godoc.org/github.com/Eacred/ecrwallet/wallet/v2/walletdb)

Full `go doc` style documentation for the project can be viewed online without
installing this package by using the GoDoc site here:
https://godoc.org/github.com/Eacred/ecrwallet/wallet/v2/walletdb

You can also view the documentation locally once the package is installed with
the `godoc` tool by running `godoc -http=":6060"` and pointing your browser to
http://localhost:6060/pkg/github.com/Eacred/ecrwallet/wallet/v2/walletdb

## Installation

```bash
$ go get github.com/Eacred/ecrwallet/wallet/v2/walletdb
```

## Examples

* [Basic Usage Example](https://godoc.org/github.com/Eacred/ecrwallet/wallet/v2/walletdb#example-package--BasicUsage)
