...
the management of the wallet and its connection to the Eacred network.  It has
...
- `string network_address`: The host/IP and optional port of the RPC server to
  ...
  default port is chosen corresponding to the default eacrd RPC port of the
...
- `string public_key`: The public key encoded as a string in the Eacred encoding
  format.
...
the Eacred network.  If the transaction spends any of the wallet's unspent
